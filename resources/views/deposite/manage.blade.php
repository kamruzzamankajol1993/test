...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="panel-heading">Bank Deposite Information</div>

        <div class="panel-body">
            <div id="tablePanel">
                <a href="{{url('/deposite/create')}}">
                    <button class="btn btn-sm btn-info" data-id=""><i class="fa fa-plus-circle"
                                                                      aria-hidden="true"></i>Deposite Amount
                    </button>
                </a>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
       ...
       <td>{{$prov->depositeBy}}</td>
      <td>
         
      </td>
     
    <td><a href="{{route('deposite.print',['id'=>$prov->id])}}" type="button" class="btn btn-info text-light">print</a></td>
    </tr>
    @endif
    @endforeach
  </tbody>
