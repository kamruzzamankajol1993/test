  ...
  <tbody>
    ...
    <tr>
        ...
        <form action="{{ route('branch.sendmoney.store') }}"  method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
        <th>
          <input type="text" name="sender_name" value="{{$prov->sender_name}}" disabled>
          <input type="hidden" name="sender_name" value="{{$prov->sender_name}}">
        </th>
        <th>
          <input type="text" name="sender_nid" value="{{$prov->sender_nid}}" disabled>
        ...
        <th>
         ...
         <input type="text" name="sender_location" value="{{ Session::get('customerAddress') }}" disabled>
        <input type="hidden" name="sender_location" value="{{ Session::get('customerAddress') }}" >
        </th>
        ...
        <th><input type="text" name="receiver_number" value="{{$prov->receiver_number}}"></th>
    ...
    <option value="anywhere">Anywhere</option>
        ...
        <th>  
              ...
              <button  type="submit" class="btn btn-info text-light" id="btnNewGroup">Next</button>
