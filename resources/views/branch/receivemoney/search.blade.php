...
<div class="col-md-6">
  ...
  <tbody>
    @foreach($details as $key=>$prov)
     @if(Session::get('customerAddress') == $prov->receiver_location || $prov->receiver_location == "anywhere")
    <tr>
        <th scope="row">{{ $key+1 }}</th>
        <form action="{{ route('branch.receivemoney.update') }}"  method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
               <th>
        ...
        <th>
          <input type="text" name="receiver_name" value="{{$prov->receiver_name}}" disabled>
           <input type="hidden" name="receiver_name" value="{{$prov->receiver_name}}">
        </th>
        <th>
          <input type="text" name="receiver_nid" value="{{$prov->receiver_nid}}" disabled>
           <input type="hidden" name="receiver_nid" value="{{$prov->receiver_nid}}">
        </th>
        <th>
          <input type="text" name="receiver_number" value="{{$prov->receiver_number}}" disabled>
          <input type="hidden" name="receiver_number" value="{{$prov->receiver_number}}">
        </th>
        ...
        <th>  
              ...
              <div>
              <button type="submit" class="btn btn-success waves-effect" name="btnSubmit" value="button1" >print</button>
              </div>
              ...
              <button  type="submit" class="btn btn-info waves-effect" name="btnSubmit" value="button2" >Get The Money</button>
