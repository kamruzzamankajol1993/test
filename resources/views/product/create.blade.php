        ...
        <div class="panel-body">
            ...
            <div class="col-md-6 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{Form::date('imdate', \Carbon\Carbon::now()->format("Y-j-n"), ['class' => 'datepicker form-control', 'data-date-format' => 'yyyy-mm-dd'])}}
                    </div>
                </div>
                <div class="form-group">
                    {{Form::label('exdate',trans('products.exdate'), ['class' => 'control-label col-sm-2'])}}
                    <div class="col-sm-10">
                        {{Form::date('exdate', \Carbon\Carbon::now()->format("Y-j-n"), ['class' => 'form-control' , 'data-date-format' => 'yyyy-mm-dd'])}}
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{Form::select('category',$category, null,  ['class' => 'my-form-control'])}}
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{Form::select('imname',$provider, null, ['class' => 'my-form-control', 'placeholder' => trans('products.provName')])}}
                    </div>
                </div>
                <div class="form-group">
