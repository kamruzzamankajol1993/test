...
<div class="col-md-3">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="{{route('cdetail',['id'=>$prov->id])}}" type="button" class="btn btn-info text-light">detail</a></td>
    </tr>
    @endif
    @endforeach
  </tbody>
              ...
              <div class="row" >
                ...
                <div class="col-md-12" style="padding-left: 30px;padding-right: 30px;">
                   <div class="form-group">
    <label class="control-label" for="pwd"><b>Check Book No:</b></label>
    <div class="">
  ...
  <div class="row" >
                <div class="col-md-6" style="padding-left: 30px;padding-right: 30px;">
                           <div class="form-group">
    <label class="control-label" for="pwd"><b>First Page No:</b></label>
    <div class="">
      <input type="text" name="checkpage_no" class="form-control" id="pwd" placeholder="Enter Check No">
                ...
                <div class="col-md-6" style="padding-left: 30px;padding-right: 30px;">
                           <div class="form-group">
    <label class="control-label" for="pwd"><b>Second Page No:</b></label>
    <div class="">
      <input type="text" name="checkpage_no_last" class="form-control" id="pwd" placeholder="Enter Check No">
