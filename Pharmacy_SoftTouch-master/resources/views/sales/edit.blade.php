    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h5>New invoice</h5>
                <hr>
                {{Form::open(['route'=>['sales.update',$sales_master->sales_master_id],'method'=>'PUT'])}}
                        ...
                        <table class="table table-bordered" id="normalinvoice">
                            ...
                            @foreach($sales_master->Saledetails as $r)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" id="total_discount_{{$loop->iteration}}" class="" value="{{$r->product_total_discount}}" />
                                        <input type="hidden" id="all_discount_{{$loop->iteration}}" class="total_discount" name="per_product_dis_percent[]" value="{{$r->per_product_dis_percent}}"/>
                            ...
                            <tr>
                                <td   colspan="7" rowspan="2" class="custom_t_head_t_center" >
                                    Invoice Details
                                    <textarea name="invoice_details" id="invoice_details_" cols="30" rows="3" class="form-control " >{{$sales_master->invoice_details}}</textarea>
                                </td>
