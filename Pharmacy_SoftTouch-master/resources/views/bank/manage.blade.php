...
<div class="col-md-3">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
         <a href="{{route('check',['id'=>$prov->id])}}" type="button" class="btn btn-info text-light">add check</a>

         <a href="{{route('bank.edit',['id'=>$prov->id])}}" type="button" class="btn btn-success text-light">edit</a>
      </td>
