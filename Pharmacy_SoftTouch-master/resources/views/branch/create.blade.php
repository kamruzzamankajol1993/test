...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
        		 ...
        		 <form action="{{ route('branch.store') }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="row" >
  ...
  <div class="row">
    ...
    <div class="">
        <input type="text" name="add" class="form-control" id="pwd" placeholder="Enter Address">
    </div>
  </div>
    </div>
