  ...
  <tbody>
    ...
    <tr>
     ...
     <td>
      ...
      <td>
         <a href="{{route('user_profile.history',['add'=>$prov->id])}}" type="button" class="btn btn-info text-light">see detail</a>
      </td>
      <td>
        @if($prov->fund_status == 1)
       <span class="label label-success">Unlimited</span>
        @else
        <span class="label label-danger">limited</span>
        @endif
      </td>
      <td>
        @if($prov->mstatus == 1)
      ...
      <td>
        ...
        <a href="{{route('user_profile.edit',['id'=>$prov->id])}}" type="button" class="btn btn-info text-light">edit</a>
