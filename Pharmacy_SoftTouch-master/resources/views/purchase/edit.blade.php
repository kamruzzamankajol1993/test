...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            {{Form::open(['route' => ['purchase.update',$purchase_master->purchase_master_id], 'files' => 'true', 'method' => 'PUT', 'class' => 'form-horizontal' ])}}
            <div class="row">
                <div class="col-md-6 col-xs-12">
                    <div class="form-group">
                        {{Form::label('supplier','Supplier',['class'=>'control-label col-sm-2'])}}
                        <div class="col-sm-10">
                            {{Form::select('supplier_id',$supplier,$purchase_master->supplier->id,['class'=>'my-form-control'])}}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::select('payment_type',array('cash'=>'Cash','bank'=>"Bank"),$purchase_master->payment_type,['class'=>'my-form-control'])}}
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xx-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {{Form::textarea('purchase_details',$purchase_master->purchase_details,['class'=>'form-control','rows'=>3])}}
                        </div>
                    </div>
                </div>
            </div>
